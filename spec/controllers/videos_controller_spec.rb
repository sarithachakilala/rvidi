...
describe VideosController do
  ...
  let(:valid_attributes) { { "video_file" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved video as @video" do
        ...
        post :create, {:video => { "video_file" => "invalid value" }}, valid_session
        assigns(:video).should be_a_new(Video)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested video" do
        ...
        Video.any_instance.should_receive(:update_attributes).with({ "video_file" => "MyString" })
        put :update, {:id => video.to_param, :video => { "video_file" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the video as @video" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Video.any_instance.stub(:save).and_return(false)
        put :update, {:id => video.to_param, :video => { "video_file" => "invalid value" }}, valid_session
        assigns(:video).should eq(video)
      end
