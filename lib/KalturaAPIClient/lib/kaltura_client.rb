...
# @ignore
# ===================================================================================================
require 'KalturaAPIClient/lib/kaltura_client_base'
...
module Kaltura
	...
	class KalturaAccessControlLimitFlavorsAction < KalturaAccessControlAction
	...
	class KalturaBatchJobBaseFilter < KalturaFilter
		...
		attr_accessor :updated_at_greater_than_or_equal
		attr_accessor :updated_at_less_than_or_equal
		attr_accessor :lock_expiration_greater_than_or_equal
		attr_accessor :lock_expiration_less_than_or_equal
		...
		def lock_expiration_greater_than_or_equal=(val)
			@lock_expiration_greater_than_or_equal = val.to_i
		end
		def lock_expiration_less_than_or_equal=(val)
			@lock_expiration_less_than_or_equal = val.to_i
		end
	...
	class KalturaBaseEntryService < KalturaServiceBase
		...
		# 	 
		def get(entry_id, version=-1, ks=KalturaNotImplemented)
			kparams = {}
			# Entry id
			client.add_param(kparams, 'entryId', entry_id);
	...
	class KalturaMediaService < KalturaServiceBase
		...
		# 	 
		def add_from_uploaded_file(media_entry, upload_token_id, ks=KalturaNotImplemented)
			kparams = {}
			# Media entry metadata
			client.add_param(kparams, 'mediaEntry', media_entry);
			client.add_param(kparams, 'ks', ks);
		...
		def list(filter=KalturaNotImplemented, pager=KalturaNotImplemented, ks=KalturaNotImplemented)
			p "ks from kaltura account is : #{ks}"
			kparams = {}
			# Media entry filter
			client.add_param(kparams, 'filter', filter);
			# Pager
			...
			# client.add_param(kparams, 'ks', 'djJ8MTQwOTA1Mny54tlEpWuIRHaNmhLSE1e0Tk8p5ujeTB5CownrQfN1x1USNwEh6rT05UCiO7kzWn268S69lTlRUsJlKTDm8Hpv6MbLJ2A1vcNktfKMpl3pas1REQgnTlnZvdsl01U1Vjo=');
...
class KalturaThumbAssetService < KalturaServiceBase
  ...
  #
  def serve(thumb_asset_id, version=KalturaNotImplemented, thumb_params=KalturaNotImplemented)
    kparams = {}
