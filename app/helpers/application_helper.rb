module ApplicationHelper
  ...
  def twitter_friends_or_existing_friends(friends, twitter_friends, request)
    ...
    if twitter_friends.present?
      render :partial => 'web/friends/twitter_users', :locals => {:twitter_friends => twitter_friends, :request_from=> request}
    else
      render :partial => 'web/friends/rvidi_users', :locals => {:users => friends}
    end
  end
